...
.single article h2{font-size:clamp(26px,3.4vw,36px);margin:76px 0 20px;padding-top:32px;border-top:1px solid var(--linea)}
...
.single .super p{margin:0;font-size:14.5px;color:var(--tinta);line-height:1.55}
...
.single details p{margin:0 0 18px;color:var(--tinta);font-size:16.5px}
